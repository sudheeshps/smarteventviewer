    ...
    void TelemetryBackgroundWorker::WorkerThreadProc()
    {
        ...
        while (s_bRunning)
        {
            ...
            try {
                ...
                TelemetryWebSocketHandler::GetInstance()->BroadcastCategoryUpdate(String("summary"));
            ...
            } catch (const DotNetDupe::System::BasicException<char>& dupeEx) {
            ...
            try {
                ...
                TelemetryWebSocketHandler::GetInstance()->BroadcastCategoryUpdate(String("processes"));
            } catch (const DotNetDupe::System::BasicSystemException<char>& sysEx) {
            ...
            if (uIterationCount % 10 == 0)
            {
                try {
                    ...
                    TelemetryWebSocketHandler::GetInstance()->BroadcastCategoryUpdate(String("sessions"));
                } catch (const DotNetDupe::System::BasicSystemException<char>& sysEx) {
